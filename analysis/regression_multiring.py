...
class WatChMaLRegression(RegressionRun, WatChMaLOutput, ABC):
    ...
    def __init__(self, directory, ring, run_label, indices=None, selection=None, **plot_args):
        """
...
class WatChMaLDirectionRegression(WatChMaLRegression, DirectionPrediction):
    ...
    def __init__(self, directory, ring, run_label, true_directions=None, indices=None, zenith_axis=None, selection=None,
                 **plot_args):
        """
...
class WatChMaLEnergyRegression(WatChMaLRegression, MomentumPrediction):
    ...
    def __init__(self, directory, ring,run_label,  true_momenta=None, true_labels=None, indices=None, selection=None,
                 **plot_args):
        """
